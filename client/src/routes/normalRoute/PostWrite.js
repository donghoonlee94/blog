...
import { Button, Form, FormGroup, Input, Label, Progress, Col } from 'reactstrap';
...
const PostWrite = () => {
  ...
  const getDateFromCKEditor = (event, editor) => {
    ...
    if (data && data.match('<img src=')) {
      ...
      console.log(result_Img_Url, 'test');
      setValues({
        ...form,
